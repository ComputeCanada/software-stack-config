...
local function set_props(t)
   ...
   local propT = {
      [ { "armadillo", "arpack-ng", "cgal", "clhep", "cudnn", "dealii", "eigen", "fftw", "fftw-mpi", "fftw-serial", "glpk", "gsl", "harminv", "igraph", "imkl", "jags", "libgpuarray", "libmesh", "libxsmm", "magma", "metis", "mpfi", "nlopt", "openblas", "p4est", "parmetis", "pcl", "python27-scipy-stack", "python35-scipy-stack", "qhull", "qrupdate", "scalapack", "scotch", "su2", "suitesparse", "superlu", "viennacl", "voro++" } ]       = { {name = "type_", value = "math" }, },
      [ { "abinit", "adf", "amber", "beast", "chemps2", "cp2k", "cpmd", "demon2k", "dl_poly4", "emboss", "gamess-us", "gaussian", "gromacs", "gromacs-plumed", "kim", "lammps", "lammps-omp", "lammps-user-intel", "libint", "libxc", "molden", "namd", "namd-mpi", "namd-multicore", "namd-verbs", "namd-verbs-smp", "nwchem", "open3dqsar", "openbabel", "openmm", "orca", "pcmsolver", "plumed", "psi4", "quantumespresso", "rosetta", "siesta", "spglib", "vasp" } ]       = { {name = "type_", value = "chem" }, },
      [ { "mpi.net", "mvapich2", "openmpi" } ]       = { {name = "type_", value = "mpi" }, },
      [ { "abyss", "admixture", "angsd", "annovar", "bamtools", "bamutil", "bbmap", "bcftools", "beagle-lib", "bedtools", "bioperl", "blast+", "blat", "bolt-lmm", "bowtie", "bowtie2", "bwa", "canu", "canvas", "centrifuge", "cnvnator", "cufflinks", "diamond", "eems", "fast-gbs", "fastqc", "fasttree", "fastx-toolkit", "freebayes", "fusioncatcher", "gatk", "gmap-gsnap", "hisat2", "hmmer", "htslib", "igblast", "impute2", "interproscan", "iq-tree", "jellyfish", "kraken", "libgtextutils", "libplinkio", "lumpy", "mach", "mafft", "maxbin", "megahit", "meraculous", "metal", "metaphlan", "minia", "minimac2", "minimac3", "mixcr", "mothur", "mrbayes", "mummer", "mummer-64bit", "nextgenmap", "ngstools", "pear", "picard", "pilon", "platypus", "plink", "pplacer", "prinseq", "prodigal", "racon", "ray", "r-bundle-bioconductor", "repasthpc", "rnammer", "rsem", "samtools", "selscan", "shotmap", "signalp", "soapdenovo2", "sortmerna", "spades", "sra-toolkit", "sspace-longread", "seqtk", "stacks", "star", "stringtie", "structure", "subread", "sumaclust", "tabix", "tmhmm", "tophat", "trans-abyss", "transdecoder", "trimal", "trimmomatic", "trinity", "trinotate", "vcftools", "vsearch" } ]       = { {name = "type_", value = "bio"}, },
      [ { "ascp", "bazel", "blitz++", "boost", "boost-mpi", "chapel", "chapel-single", "chapel-slurm-gasnetrun_ibv", "cuda", "eclipse", "elixir", "erlangotp", "gcc", "guile", "intel", "ipp", "java", "julia", "libctl", "matlab", "maven", "mcr", "mono", "python27-mpi4py", "python35-mpi4py", "octave", "perl", "perl4-corelibs", "petsc", "petsc-64bits", "protobuf", "python", "pypy", "qt", "qt5", "r", "root", "rstudio-server", "ruby", "rubygems", "sip", "snappy", "spark", "tbb", "tcl", "trilinos", "udunits", "yaxt" } ]          = { {name = "type_", value = "tools"}, },
      [ { "abaqus", "ansys", "cgns", "cst", "grackle", "geant4", "ls-dyna", "ls-dyna-mpi", "meep", "openfoam", "starccm", "starccm-mixed", "shengbte" } ] = { {name = "type_", value = "phys"}, },
      [ { "ccsm", "cdo", "cesm", "cwp_su", "esmf", "gdal", "g2clib", "g2lib", "geos", "gmt", "proj", "wps", "wrf", "wrf-fire" } ] = { {name = "type_", value = "geo"}, },
      [ { "ccfits", "glm", "jasper", "ncl", "ncview", "opencv", "paraview", "paraview-offscreen", "paraview-offscreen-gpu", "visit", "vmd", "vtk", "xcrysden" } ] = { {name = "type_", value = "vis"}, },
