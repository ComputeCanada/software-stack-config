...
local function set_props(t)
   ...
   local propT = {
      [ { "armadillo", "arpack-ng", "blacs", "cgal", "clhep", "cudnn", "dealii", "dealii-petsc", "eigen", "elpa", "fftw", "fftw-mpi", "fftw-serial", "flint", "glpk", "gsl", "harminv", "igraph", "imkl", "jags", "libcerf", "libgpuarray", "libmatheval", "libmesh", "libtricubic", "libxsmm", "lis", "lpsolve", "magma", "mcl", "mesquite", "metis", "mpfi", "muparser", "nektar++", "nlopt", "ntl", "openblas", "p4est", "parmetis", "parmgridgen", "pcl", "pfft", "python27-scipy-stack", "python35-scipy-stack", "qhull", "qrupdate", "scalapack", "scipy-stack", "scotch", "sprng", "su2", "suitesparse", "superlu", "viennacl", "voro++", "wham", "xgboost" } ]       = { {name = "type_", value = "math" }, },
